...
{
	DebugComponentData componentData = { label + "##" + typeName, D_INT, data, getterFunc, setterFunc };
...
{
	DebugComponentData componentData = { label + "##" + typeName, D_COLOR, data, getterFunc, setterFunc };
	d_debugComponentData.push_back(componentData);
}
...
{
	DebugComponentData componentData = { label + "##" + typeName, D_ENUM, data, getterFunc, setterFunc, hash };
	d_debugComponentData.push_back(componentData);
}
...
{
	DebugComponentData componentData = { label + "##" + typeName, D_STRUCT, data, getterFunc, setterFunc, hash, stride };
	d_debugComponentData.push_back(componentData);
}

void Component::debugAddTexture(std::string label, Texture** data, DebugGetterFunc getterFunc, DebugSetterFunc setterFunc)
{
	DebugComponentData componentData = { label + "##" + typeName, D_TEXTURE, data, getterFunc, setterFunc };
	d_debugComponentData.push_back(componentData);
}

void Component::debugAddMaterial(std::string label, Material** data, DebugGetterFunc getterFunc, DebugSetterFunc setterFunc)
{
	DebugComponentData componentData = { label + "##" + typeName, D_MATERIAL, data, getterFunc, setterFunc };
	d_debugComponentData.push_back(componentData);
}

void Component::debugAddModel(std::string label, Mesh** data, DebugGetterFunc getterFunc, DebugSetterFunc setterFunc)
{
	DebugComponentData componentData = { label + "##" + typeName, D_MODEL, data, getterFunc, setterFunc };
	d_debugComponentData.push_back(componentData);
}
...
{
	DebugComponentData componentData = { label + "##" + typeName, D_VERTEX_SHADER, data, getterFunc, setterFunc };
	d_debugComponentData.push_back(componentData);
}
...
{
	DebugComponentData componentData = { label + "##" + typeName, D_PIXEL_SHADER, data, getterFunc, setterFunc };
	d_debugComponentData.push_back(componentData);
}

void Component::debugAddSampler(std::string label, Sampler** data, DebugGetterFunc getterFunc, DebugSetterFunc setterFunc)
{
	DebugComponentData componentData = { label + "##" + typeName, D_SAMPLER, data, getterFunc, setterFunc };
	d_debugComponentData.push_back(componentData);
}

void Component::debugAddFont(std::string label, Font** data, DebugGetterFunc getterFunc, DebugSetterFunc setterFunc)
{
	DebugComponentData componentData = { label + "##" + typeName, D_FONT, data, getterFunc, setterFunc };
	d_debugComponentData.push_back(componentData);
}
