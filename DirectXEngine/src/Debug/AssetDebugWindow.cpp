...
void AssetDebugWindow::addAsset(Texture* texture)
{
	...
	if (AssetManager::isDefaultAsset(texture->getAssetID())) return;
...
void AssetDebugWindow::addAsset(Material* material)
{
	...
	if (AssetManager::isDefaultAsset(material->getAssetID())) return;
...
{
#if defined(DEBUG) || defined(_DEBUG)
	// Don't show the default mesh in the debug window, since it shouldn't be changed.
	if (AssetManager::isDefaultAsset(mesh->getAssetID())) return;
...
void AssetDebugWindow::addAsset(Font* font)
{
	...
	if (AssetManager::isDefaultAsset(font->getAssetID())) return;
...
void AssetDebugWindow::addAsset(Sampler* sampler)
{
	...
	if (AssetManager::isDefaultAsset(sampler->getAssetID())) return;
...
void AssetDebugWindow::addAsset(VertexShader* vertexShader)
{
	...
	if (AssetManager::isDefaultAsset(vertexShader->getAssetID())) return;
...
void AssetDebugWindow::addAsset(PixelShader* pixelShader)
{
	...
	if (AssetManager::isDefaultAsset(pixelShader->getAssetID())) return;
